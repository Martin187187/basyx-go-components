...
// TestWorkshopMedium runs medium-level cases defined in tests/medium/testcases.json.
func TestWorkshopMedium(t *testing.T) {
	truncateDatabase(t)
	...
	casesPath := filepath.Join("tests", "medium", "testcases.json")
	raw, err := os.ReadFile(casesPath)
	if err != nil {
		t.Fatalf("read cases: %v", err)
	}
	var cases []mediumCase
